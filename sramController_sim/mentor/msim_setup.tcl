...
# ACDS 13.0sp1 232 win32 2020.01.22.17:22:26
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sramController"
} 
...
alias com {
  echo "\[exec\] com"
  vcom "$QSYS_SIMDIR/sramController.vhd"
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
